        ...
        <div class="container">
            <div class="page mt-10">
                ...
                <div class="col-sm-8 text-center signin">
                    ...
                    <!-- Default form login -->
                    <form action="">
                    <p class="h4 mb-4 text-center signintext top"><strong>Sign Up to HospitalMitra</strong></p>
                ...
                <div class="social-btn text-center">
                    ...
                    <input type="text" class="form-control mb-4" placeholder="&#xf023;  Username" style="font-family:Arial, FontAwesome">

                    <!-- Email -->
                    <input type="email" class="form-control mb-4"  placeholder="&#xf0e0; Email" style="font-family:Arial, FontAwesome">

                     <!-- mobile  -->
                    <input type="text" class="form-control mb-4"  placeholder="&#xf095; Mobile Number" style="font-family:Arial, FontAwesome">
                
                    <!-- Password -->
                    <input type="password" class="form-control mb-4" placeholder="&#xf023;  Password" style="font-family:Arial, FontAwesome">

                    <input type="password" class="form-control mb-4" placeholder="&#xf023;   Confirm Password" style="font-family:Arial, FontAwesome">
